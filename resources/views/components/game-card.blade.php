    ...
    <div class="relative inline-block">
        <a href="{{route('games.show', $game['slug'])}}">
            @if (isset($game['cover']['url']))
                <img src="{{ $game['coverImageUrl'] }}" alt="game cover" class="hover:opacity-75 transition ease-in-out duration-150 h-3/2 md:h-3/5 " style="max-width: 170.6px; height:227px">
            @endif
        </a>
        @if ($game['rating'])
