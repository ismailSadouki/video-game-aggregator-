...
@section('content')
    ...
    <div class="container mx-auto px-20">
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            <div class="flex-none">
                <img src="{{ $game['coverImageUrl'] }}" alt="cover" height="352px">
            </div>
            <div class="lg:ml-12 lg:mr-64">
                ...
                <div class="flex flex-wrap items-center mt-8 ">
                    <div class="flex items-center">
                        <div id="memberRating" class="w-16 h-16 bg-gray-800 rounded-full relative text-xs font-semibold ">
                            @push('scripts')
                        ...
                        <div id="criticRating" class="w-16 h-16 bg-gray-800  rounded-full ml-12 relative text-xs font-semibold ">
                            @push('scripts')
                ...
                <div class="mt-12" x-data="{ isTrailerModalVisible: false }">
                   ...
                   @if (!empty($game['videos'][0]))
                        ...
                        <template x-if="isTrailerModalVisible">
                            ...
                            >
                                <div class="container mx-auto lg:px-52 rounded-lg overflow-y-auto">
        ...
        <div 
            class="images-container  border-gray-800 pb-12 mt-8" 
                ...
                @forelse ($game['screenshots'] as $screenshot)
                    <div> 
                        ...
                        >
                            ...
                            <img src="{{ $screenshot['big'] }}" alt="screenshot1" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
                    </div>    
                @empty 
                    nothing    
